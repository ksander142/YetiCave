...
--запись лотов
insert into lots set name='2014 Rossignol District Snowboard',description='opisanie opisannoe',url='img/lot-1.jpg',cost=10999,add_date='2019-10-11',date='2020-01-11',user_id='1',categories_id='1';
insert into lots set name='DC Ply Mens 2016/2017 Snowboard',description='zzzzzzzzzzzzzzzzzzz',url='img/lot-2.jpg',cost=159990,date='2019-12-01',user_id='1',categories_id='1';
...
insert into lots set name='Ботинки для сноуборда DC Mutiny Charocal',description='789999',url='img/lot-4.jpg',cost=10999,date='2019-12-23',user_id='1',categories_id='3';
insert into lots set name='Куртка для сноуборда DC Mutiny Charocal',description='xxxxxxxxxxxxxx',url='img/lot-5.jpg',cost=7500,date='2019-11-15',user_id='1',categories_id='4';
